...
class PostDetailView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.user.is_authenticated and self.post_instance.user_can_like(request.user):
            can_like = True
        return render(request, 'home/detail.html', context={'post': self.post_instance, 'comments': comments, 'form': self.form_class, 'reply_from': self.form_class_reply, 'can_like': can_like})
